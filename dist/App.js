...
function AppRoutes() {
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/auth", element: _jsx(PublicRoute, { children: _jsx(AuthPage, {}) }) }), _jsx(Route, { path: "/", element: _jsx(Navigate, { to: "/home", replace: true }) }), _jsx(Route, { path: "/home", element: _jsx(GuestOrAuthRoute, { children: _jsx(Layout, { children: _jsx(HomePage, {}) }) }) }), _jsx(Route, { path: "/chat", element: _jsx(GuestOrAuthRoute, { children: _jsx(Layout, { children: _jsx(ChatPage, {}) }) }) }), _jsx(Route, { path: "/quiz", element: _jsx(GuestOrAuthRoute, { children: _jsx(Layout, { children: _jsx(QuizPage, {}) }) }) }), _jsx(Route, { path: "/quiz-results", element: _jsx(GuestOrAuthRoute, { children: _jsx(Layout, { children: _jsx(QuizResultsPage, {}) }) }) }), _jsx(Route, { path: "/profile", element: _jsx(ProtectedRoute, { children: _jsx(Layout, { children: _jsx(ProfilePage, {}) }) }) })] }));
}
function App() {
