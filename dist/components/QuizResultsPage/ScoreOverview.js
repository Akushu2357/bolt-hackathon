...
export default function ScoreOverview({ actualScore, correctCount, totalQuestions, showAnswers, setShowAnswers, retakeQuiz, partialCount = 0, quizContext, showChatIntegration = true }) {
    const { user } = useAuth();
