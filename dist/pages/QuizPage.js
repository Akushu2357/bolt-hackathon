    ...
    const finishQuiz = async () => {
        ...
        try {
            ...
            if (user) {
                ...
                await QuizDataService.saveQuizAttempt(currentQuiz.id, user.id, filteredAnswers, scoringResult.score);
                // Update learning progress
                await LearningProgressService.updateLearningProgress(user.id, currentQuiz, filteredAnswers, scoringResult.score, scoringResult.gradingResults);
                fetchAttempts();
            }
            else {
