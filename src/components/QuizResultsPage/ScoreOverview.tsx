...
import {
  Trophy, CheckCircle, XCircle, Star, Eye, EyeOff, RotateCcw, AlertTriangle, Lock, MessageCircle
} from 'lucide-react';
...
interface ScoreOverviewProps {
  ...
  retakeQuiz: () => void;
  partialCount?: number;
  quizContext?: QuizChatContext; // เพิ่มสำหรับ discuss
  showChatIntegration?: boolean; // ถ้าต้องการเปิด/ปิดปุ่ม discuss
}
    ...
    <div className={`card mb-6 sm:mb-8 ${getScoreBgColor(actualScore)}`}>
      <div className="text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          {user && quizContext && showChatIntegration && (
            <button
