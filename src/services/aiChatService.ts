...
export class AIChatService {
   ...
   */
  private static generateMockResponse(message: string): string {
    const responses = [
   ...
   */
  static getProviderStatus(): Record<string, { available: boolean; name: string }> {
   ...
   */
  static async testProvider(provider: 'openai' | 'groq' | 'anthropic'): Promise<boolean> {
    try {
